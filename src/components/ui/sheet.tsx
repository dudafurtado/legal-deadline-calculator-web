...
const SheetFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 absolute right-0 left-0 bottom-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("text-2xl font-bold text-foreground mb-4", className)}
    {...props}
  />
));
